...
<section class="vh-100" style="background-color: #f4f5f7; padding-top: 20px; padding-bottom: 10px;">
  <div class="container py-9n h-100 slide-in-from-top">
    ...
    <img src="admin.jpg" alt="Avatar" class="img-fluid my-5 slide-in-from-left" style="width: 250px;border-radius:10px" />
    <h5 class="slide-in-from-left">${admin.uname}</h5>
    <h5 class="slide-in-from-left">${admin.email}</h5>
              ...
              <div class="card-body p-5 ">
                ...
                <div class="row pt-1">
                  ...
                  <div class="col-6 mb-4 slide-in-from-left">
                    <h6>User Name</h6>
                    <p class="text-muted">${admin.uname }</p>
                  </div>
                  
                   <div class="col-6 mb-4 slide-in-from-left">
                    <h6>Password</h6>
                    <p class="text-muted">${admin.pass }</p>
                  </div>
