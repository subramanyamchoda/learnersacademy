...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assert/img/logo.jpeg">
    <title> Profile   </title>
...
<section class="vh-100" style="background-color: #f4f5f7; padding-top: 20px; padding-bottom: 10px;">
  <div class="container py-9n h-100 slide-in-from-top">
    ...
    <img src="inst.jpg" alt="Avatar" class="img-fluid my-5 slide-in-from-left" style="width: 120px;" />
    <h5 class="slide-in-from-left">${teacher.uname}</h5>
    <h5 class="slide-in-from-left">${teacher.email}</h5>
    	 <i class="far fa-edit mb-5"></i>
    <div class="social-icons mt-3 slide-in-from-left">
    ...
    <p></p>
            ...
            <div class="col-md-7">
              <div class="card-body p-5 ">
                <h6 class="slide-in-from-right">Information</h6>
                <hr class="mt-0 mb-4">
                <div class="row pt-1">
                  <div class="col-6 mb-4 slide-in-from-left">
                    <h6>first Name</h6>
                    <p class="text-muted">${teacher.f_name}</p>
                  </div>
                  <div class="col-6 mb-4 slide-in-from-right">
                    <h6>last Name</h6>
                    <p class="text-muted">${teacher.l_name}</p>
                  </div>
                  ...
                  <div class="col-6 mb-4 slide-in-from-right">
                    <h6>Phone</h6>
                    <p class="text-muted">${teacher.mobile }</p>
                  </div>
                  <div class="col-6 mb-4 slide-in-from-left">
                    <h6>Address</h6>
                  ...
                  <div class="col-6 mb-4 slide-in-from-left">
                    <h6>Age</h6>
                    <p class="text-muted">${teacher.age}</p>
                  </div>
                  <div class="col-6 mb-4 slide-in-from-right">
                    <h6>Gender</h6>
